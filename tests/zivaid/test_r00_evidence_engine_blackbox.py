...
class TestR00EvidenceEngineBlackBox(unittest.TestCase):
    ...
    def test_006_existing_participant_is_quarantined(self):
        ...
        result = validate(
            record,
            existing_participant_ids=[TEST_PARTICIPANT_ID],
    ...
    def test_007_contradiction_is_not_invalidity(self):
        ...
        self.assertTrue(
            any(r["rule_id"] == "R00-EVID-004" and r["result"] == "pass" for r in result["rule_results"])
        )
    ...
    def test_009_identical_input_is_deterministic(self):
        ...
        for key in (
            "final_disposition", "rule_results", "input_fingerprint",
            "validation_id", "ruleset_id", "engine_version",
        ):
